...
var importBenchCmd = &cli.Command{
	...
	Action: func(cctx *cli.Context) error {
		...
		stm, err := stmgr.NewStateManager(cs, consensus.NewTipSetExecutor(filcns.RewardFunc), vm.Syscalls(verifier), filcns.DefaultUpgradeSchedule(), nil, datastore.NewMapDatastore())
		if err != nil {
			return err
		}
